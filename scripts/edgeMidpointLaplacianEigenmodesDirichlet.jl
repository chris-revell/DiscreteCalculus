...
# display(fig)
save(projectdir("scripts","plots","edgeMidpointLaplacianDirichletEigenmodeTableau2.png"),fig)
...
save(projectdir("scripts","plots","edgeMidpointLaplacianDirichletEigenvalueSpectrum2.png"),fig2)
# display(fig2)