...
L = edgeMidpointLDirichlet(R, A, B)
...
# display(fig)
save(projectdir("scripts","plots","edgeMidpointLaplacianDirichletEigenmodeTableau3.png"),fig)
...
save(projectdir("scripts","plots","edgeMidpointLaplacianDirichletEigenvalueSpectrum3.png"),fig2)
# display(fig2)