...
# display(fig)
save(projectdir("scripts","plots","edgeMidpointLaplacianNeumannEigenmodeTableau2.png"),fig)
...
save(projectdir("scripts","plots","edgeMidpointLaplacianNeumannEigenvalueSpectrum2.png"),fig2)
# display(fig2)